...
Here’s how to start using nmap-mcp quickly and without hassle.
...
## 🛠️ How to Use nmap-mcp

Once installed, nmap-mcp offers an easy interface to run scans. Here are common tasks:

### Run a Port Scan

1. Enter the IP address or domain name you want to check.
2. Choose the type of scan - simple port scan or full scan.
3. Click “Start Scan.”
4. Wait for the results which show open ports and the services on them.
...
- **Application won’t start:** Make sure your OS and hardware meet the minimum requirements. Try reinstalling the program.
